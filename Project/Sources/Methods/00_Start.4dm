...
Case of 
	...
	Else 
		...
		$options.title:=""
		$options.title:=$options.title+"fully manage listbox settings with \"LISTBOX SET PROPERTY\"\r"
		$options.title:=$options.title+"and \"LISTBOX Get property\" commands?"
		$options.blog:="blog.4d.com"
		$options.info:="List boxes"  //ex : "4D View Pro feature"
		
		$options.minimumVersion:="1960"  // 1960 means 19R6   1906 means 19.6 (do not use !)
